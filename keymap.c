...
#define MDIA 3 // media and F keys
#define MISC 4 // other random keys
...
[BASE] = LAYOUT_ergodox(
        ...
        LGUI_T(KC_ESC),  KC_A, LT(MDIA, KC_R),     LT(MISC,KC_S),    LT(MOUS, KC_T),  KC_D,
        ...
        // right hand
             ...
             TG(QWER),    KC_J,   KC_L,             KC_U,     KC_Y,   KC_SCLN,          KC_BSLASH,
                          KC_H,   LT(MOUS, KC_N),   LT(MISC,KC_E),     LT(MDIA,KC_I),   KC_O,   RGUI_T(KC_QUOT),
...
[QWER] = LAYOUT_ergodox(
        ...
        KC_TRNS,KC_A, LT(MDIA,KC_S),      LT(MISC,KC_D),      LT(MOUS, KC_F),KC_G,
        ...
        // right hand
             ...
             KC_TRNS,     KC_Y,      KC_U,          KC_I,    KC_O,    KC_P,             KC_TRNS,
                          KC_H,      LT(MOUS, KC_J),LT(MISC,KC_K),    LT(MDIA,KC_L),    KC_SCLN,KC_TRNS,
